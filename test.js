...
test("'source' is a file", async t => {
    ...
    const contents = await readFile("out/index-root.html", 'utf-8');
...
test("'source' is a relative path to a file", async t => {
    ...
    const contents = await readFile("out/src/index-dir.html", 'utf-8');
    t.is(contents, '0,1,2,3,4');
})
...
test("'source' is a directory", async t => {
    ...
    const contents = await readFile("out/index-dir.html", 'utf-8');
    t.is(contents, '0,1,2,3,4');
})
...
test("'out' is a file", async t => {
    ...
    const contents = await readFile("output.html", 'utf-8');
    t.is(contents, '0,1,2,3,4');
})
...
test("'out' is a path to a file", async t => {
    ...
    const contents = await readFile("out/output.html", 'utf-8');
    t.is(contents, '0,1,2,3,4');
})
